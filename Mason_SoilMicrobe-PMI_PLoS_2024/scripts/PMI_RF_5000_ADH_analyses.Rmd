...
```{r, include = FALSE}
#load the datasets:
all_rf_results = readRDS(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/all_rf_results.RDS"))
```
...
mean_values %>%
  ...
  kableExtra::save_kable(., file = here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/all_rf_summary_table.pdf"))
...
mean_values %>%
  ...
  column_spec(7, width = "2cm") %>%
  column_spec(8, width = "2cm") %>%
  kableExtra::save_kable(., file = here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S2Table.pdf"))
```
...
# %>%
#   save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/all_mods_test-train_lm.pdf"), keep_tex = FALSE)
  
# write_csv(y, here::here("Mason_SoilMicrobe-PMI_PLoS_2024/data/all_mods_test-train_lm.csv"))
```
...
y %>% 
  ...
  kbl(.,
    ...
    booktabs = TRUE,
    escape = F) %>%
  save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S3Table.pdf"), keep_tex = FALSE)
```
...
```{r, include=FALSE, eval=FALSE}
tiff(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/Fig2.tiff"), units = "in", width = 7.5, height = 5.5, res = 300)
ggarrange(mod1_train_predictions, mod2_train_predictions, mod3_train_predictions, mod1_test_predictions, mod2_test_predictions, mod3_test_predictions,
          nrow = 2,
          ncol = 3,
          labels = c("A", "B", "C", "D", "E", "F"),
...
write_csv(mae_tax_posthoc_t, here::here("Mason_SoilMicrobe-PMI_PLoS_2024data/mae_marker_posthoc_t_results.csv"))
...
mae_tax_posthoc_t %>%
  ...
  kbl(.,
      ...
      booktabs = TRUE,
      escape = FALSE) %>% 
  save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/MAE_biologicalMarker_posthoct.pdf"), keep_tex = FALSE)
...
mae_tax_posthoc_t %>%
  ...
  kbl(.,
      ...
      booktabs = TRUE,
      escape = FALSE) %>% 
  save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S5Table.pdf"), keep_tex = FALSE)
```
...
```{r, include=FALSE, eval=FALSE}
tiff(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/Fig3.tiff"), units = "in", width = 4, height = 4, res = 300)
mae_marker_box
dev.off()
```
...
kbl(mae_taxlevel_anova_p,
    ...
    digits = 3,
    booktabs = TRUE) %>% 
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/MAE_taxlevel_anova.pdf"), keep_tex = FALSE)
```
...
kbl(mae_taxlevel_anova_p,
    ...
    digits = 3,
    booktabs = TRUE) %>% 
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S6Table.pdf"), keep_tex = FALSE)
```
...
rbind(mae_16S_tax_level_anova, mae_16SITS_tax_level_anova, mae_ITS_tax_level_anova) %>%
  ...
  kbl(.,
    ...
    digits = 3,
    booktabs = TRUE) %>% 
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/MAE_taxlevel_biomarker_anova.pdf"), keep_tex = FALSE)
```
...
rbind(mae_16S_tax_level_anova, mae_16SITS_tax_level_anova, mae_ITS_tax_level_anova) %>%
  ...
  kbl(.,
    ...
    digits = 3,
    booktabs = TRUE) %>% 
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S7Table.pdf"), keep_tex = FALSE)
```
...
```{r, include=FALSE, eval=FALSE}
tiff(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/Fig4.tiff"), units = "in", width = 6, height = 3.5, res = 300)
mae_taxlevel_box
dev.off()
```
...
```{r, include=FALSE, warning=FALSE}
bact_phylum_tax_table <- read_excel(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_Phylum_taxtable.xlsx"))
...
bact_order_tax_table <- read_excel(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_Order_taxtable.xlsx"))
its_order_tax_table <- read_excel(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_ITS_TSS_Order_taxtable.xlsx"))
...
top_mods_imp %>%
  ...
  save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/top_models_featureimportance.pdf"))
...
top_mods_imp %>%
  ...
  pack_rows("16S-ITS order noenv", 26, 50, latex_gap_space = "1em") %>%
  pack_rows("ITS order env", 51, 75, latex_gap_space = "1em") %>%
  save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S8Table.pdf"))
...
```{r, include=FALSE, eval=FALSE}
tiff(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/Fig6.tiff"), units = "in", width = 7.5, height = 5.5, res = 300)
phylum_plot
dev.off()
```
...
kbl(metadata_table,
    ...
    booktabs = TRUE,
    align = 'c') %>%
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/Donor_metadata.pdf"), keep_tex = FALSE)
```
...
kbl(metadata_table,
    ...
    booktabs = TRUE,
    align = 'c') %>%
save_kable(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S1Table.pdf"), keep_tex = FALSE)
```
...
```{r, include=FALSE, eval=FALSE}
tiff(here::here("Mason_SoilMicrobe-PMI_PLoS_2024/figures/S2Fig.tiff"), units = "in", width = 7.5, height = 5.5, res = 300)
order_plot
dev.off()
```
