...
```{r, include = FALSE}
#load the datasets:
bact.n.otu = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_meta_OTUtable.xlsx"))
bact.n.class = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_meta_Class_table.xlsx"))
bact.n.order = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_meta_Order_table.xlsx"))
bact.n.phylum = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_meta_Phylum_table.xlsx"))

ITS.n.otu = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_ITS_TSS_meta_OTU_table.xlsx"))
ITS.n.class = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_ITS_TSS_meta_Class_table.xlsx"))
ITS.n.order = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_ITS_TSS_meta_Order_table.xlsx"))
ITS.n.phylum = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_ITS_TSS_meta_Phylum_table.xlsx"))

# load pruned datasets (singletons and doubletons removed prior to TSS):
bact.n.prune.otu = read_xlsx(here("Mason_SoilMicrobe-PMI_PLoS_2024/data/TOX2_16S_TSS_meta_prune_OTUtable.xlsx"))
```
...
saveRDS(all_rf_results, here::here("Mason_SoilMicrobe-PMI_PLoS_2024/data/all_rf_results.RDS"))
```
