...
write_xlsx(bact.n_meta_p, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_meta_Phylum_table.xlsx") )
write_xlsx(bact.n_p_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_Phylum_taxtable.xlsx") )
...
write_xlsx(bact.n_meta_c, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_meta_Class_table.xlsx") )
write_xlsx(bact.n_c_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_Class_taxtable.xlsx"))
...
write_xlsx(bact.n_meta_o, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_meta_Order_table.xlsx") )
write_xlsx(bact.n_o_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_16S_TSS_Order_taxtable.xlsx"))
...
write_xlsx(ITS.n_meta_otu, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_meta_OTU_table.xlsx") )
write_xlsx(ITS.n_OTU_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_OTU_taxtable.xlsx") )
...
write_xlsx(ITS.n_meta_p, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_meta_Phylum_table.xlsx"))
write_xlsx(ITS.n_p_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_Phylum_taxtable.xlsx")) 
...
write_xlsx(ITS.n_meta_c, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_meta_Class_table.xlsx") )
write_xlsx(ITS.n_c_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_Class_taxtable.xlsx") )
...
write_xlsx(ITS.n_meta_o, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_meta_Order_table.xlsx"))
write_xlsx(ITS.n_o_tax_table, here("Mason_SoilMicrobe-PMI_XXXXX_2023/data/TOX2_ITS_TSS_Order_taxtable.xlsx"))
